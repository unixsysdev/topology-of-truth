...
\begin{enumerate}
  \item \textbf{Readout intervention (primary):} apply a minimal intervention at verdict time (e.g., additive Unknown logit correction or probe-guided residual steering) and test whether Unknown emission and tri-label accuracy improve without changing upstream representation.
...
\newblock \url{https://www.alignmentforum.org/posts/2R8YpY8cL4ePj4Aqk/eliciting-latent-knowledge-how-to-tell-if-your-eyes-deceive}. Accessed 2026-04-14.
